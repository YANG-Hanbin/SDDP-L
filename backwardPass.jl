...
function setupCutGenerationInfo(
    ...
    uₙ = StageInfo(
        ...
        stateInfo.IntVar === nothing ?
            nothing :
            stateInfo.IntVar .- coreStatePLC.IntVar,
        stateInfo.IntVarLeaf === nothing ?
            nothing :
            Dict(
                g => Dict(
                    k => stateInfo.IntVarLeaf[g][k] - coreStatePLC.IntVarLeaf[g][k] for k in keys(stateInfo.IntVarLeaf[g])
                ) for g in keys(stateInfo.IntVarLeaf)
            ),
        stateInfo.IntVarBinaries === nothing ?
            nothing :
            stateInfo.IntVarBinaries .- coreStatePLC.IntVarBinaries,
    );
